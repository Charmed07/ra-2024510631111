...
public class ProdutoRepositorioDocumento : IProdutoRepositorio
{
    ...
    public Produto? ObterPorId(int id)
    {
        ...
        // Acesso direto pela chave: se não existir, retorna nulo
    ...
    public Produto Criar(Produto produto)
    {
        ...
        produto.Id = todos.Any() ? todos.Max(p => p.Id) + 1 : 1;

        
        var json = JsonSerializer.Serialize(produto, new JsonSerializerOptions { WriteIndented = true });
