...
> **Nomes:** João Antonio De Souza Santos   **Turma:** ____________________   **Data:** 10/09/2026 
...
|Cliente|---CONSULTA SALDO/LIMITE---|Venda aprovada/reprovada| 

3. Justificativa (mínimo 2 fatores): Cliente aguarda a resposta do sistema , sem a consulta não é possivel seguir para outra operação.

4. Principal risco da escolha: Em caso de queda da internet, o cliente não recebe o retorno da requisição e fica preso ne tela aguardando o retorno.
...
|  |
|CLIENTE|---REALIZA O PROCESSO DE CADASTRO---|ENCAMINHA AS BOAS VINDAS|

3. Justificativa (mínimo 2 fatores): Cliente pode acessar o app sem precisar da confirmação de boas vindas e o e-mail é enviado sem que o usuario precise fazer uma nova requisição

4. Principal risco da escolha: Risco pode ser a falta de complementp no cadastro caso venha instruções na mensagem de boas vindas 
...
|Venda|---VERIFICA ESTOQUE/BAIXA DE ESTOQUE---|GERA PEDIDO|

3. Justificativa (mínimo 2 fatores): O atraso de baixar o produto em estoque 
